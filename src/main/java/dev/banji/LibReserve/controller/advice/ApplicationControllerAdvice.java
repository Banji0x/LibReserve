...
public class ApplicationControllerAdvice {
    ...
    @ExceptionHandler
    ProblemDetail authenticationServiceException(AuthenticationServiceException authenticationServiceException) {
        return ProblemDetail.forStatusAndDetail(HttpStatus.UNAUTHORIZED, authenticationServiceException.getMessage());
    }
